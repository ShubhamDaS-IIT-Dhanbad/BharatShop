...
const ProductDetails = () => {
    ...
    const [productDetail, setProductDetails] = useState(1);
    const [shopDetails, setShopDetails] = useState(true);
                    ...
                    <Fragment>
                        <div className="ProductDetails">
                            <div className="ProductDetails-left">
                                ...
                                <img className="Product-details-image-right" src={productDetail.images[0]} alt={productDetail.title} />
                            </div>
                            <div className="ProductDetails-right">
                                    ...
                                    <span className="detailsBlock-2-span">
                                        <div className="detailsBlock-shopName-container">
                                            ...
                                            <span onClick={redirectToMap}>
                                                <MdOutlineAddLocationAlt size={20} fontWeight={100} color={"black"} />
                                            </span>
                                        </div>
                                        <Rating
                                            count={5}
                                ...
                                <div className="detailsBlock-3">
                                    ...
                                    <div className="detailsBlock-3-1">
                                        ...
                                        <button disabled={productDetail.quantityAvailable <= 0} style={{ width: "70%", height: "40px", fontSize: "14px", fontWeight: "500" }}>
                                            Add to Cart
                                        </button>
                                    </div>
                                    <p>
